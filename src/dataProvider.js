...
export default (apiUrl, httpClient = fetchUtils.fetchJson) => {
    ...
    const convertDataRequestToHTTP = (type, resource, params) => {
        ...
        // handle scope-to-roles & role-to-scopes: which use the same backend endpoint
        const resource_name = resource === "role-to-scopes" ? "scope-to-roles" : resource;
        switch (type) {
            case GET_LIST: {
                ...
                url = `${apiUrl}/${resource_name}/?${stringify(query)}`;
                break;
            }
            case GET_ONE:
                url = `${apiUrl}/${resource_name}/${params.id}`;
                break;
            case GET_MANY: {
                const query = {
            ...
            case "getTree": {
                ...
                url = `${apiUrl}/trees/${resource_name}?${stringify(query)}`;
                break;
            }
